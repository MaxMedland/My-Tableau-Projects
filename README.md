...
* **Multi-View Orchestration:** Designing cohesive dashboards that synchronize multiple worksheets (Bar, Line, Scatter, and Map) to provide a 360-degree view of the data.
* **Executive Storytelling:** Distilling raw data into "at-a-glance" insights for non-technical stakeholders while maintaining deep-dive capabilities for analysts.
* **Deployment:** Proficient in publishing, managing, and sharing secure workbooks via **Tableau Public**.
...
* **Calculated Fields:** Writing custom syntax for complex metrics including Life Expectancy averages, BMI ratios, and population density.
* **Table Calculations:** Expertise in converting raw values into **Percentage of Total**, Year-over-Year (YoY) growth, and running totals.
* **Data Synthesis:** Cleaning and reshaping disparate datasets (Gapminder, Spotify, UK Employment) to ensure accuracy and visual integrity.
